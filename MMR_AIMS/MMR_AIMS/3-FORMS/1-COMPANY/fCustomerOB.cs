...
namespace MMR_AIMS
{
    public partial class fCustomerOB : Form
    {
        #region Data Fields
        int ID = 0;
        long COAId = 0;
        ...
        void LoadList()
        {
            try
            {
                ...
                DataTable dt = ((DataSet)model.GetList("CUSTOMER")).Tables[0];
        ...
        private void mnuEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OBModel model = new OBModel();
                DataTable dt = ((DataSet)model.GetCustomerOB(ID)).Tables[0];
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                obj.RefId = ID;
                obj.COAId = COAId;
                obj.COACode = "CUSTOMER";
                obj.Debit =Convert.ToDecimal( txtOB.Text);
                obj.Credit = 0;
