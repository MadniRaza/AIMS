...
namespace MMR_AIMS
{
    public partial class fFiscalYears : Form
    {
        #region Data Fields
        int ID = 0;
        ...
        void LoadList()
        {
            try
            {
                ...
                DataTable dt = ((DataSet)model.GetFiscalYearList()).Tables[0];
        ...
        private void mnuEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtNo.Text = dt.Rows[0]["FiscalYearId"].ToString();
                dtpFrom.Value =Convert.ToDateTime(dt.Rows[0]["FromDate"].ToString());
                dtpTo.Value = Convert.ToDateTime(dt.Rows[0]["ToDate"].ToString());
        ...
        public void FilterRecords()
        {
            ...
            if (!string.IsNullOrEmpty(search_value))
            {
                ...
                filter_text += " OR Convert(FromDate,'System.String') LIKE '%" + search_value + "%' ";
                filter_text += " OR Convert(ToDate,'System.String') LIKE '%" + search_value + "%' ";
                filter_text += " )";
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FiscalYearModel modelItem = new FiscalYearModel();
                FiscalYearModel.FiscalYear obj = new FiscalYearModel.FiscalYear();
                obj.FiscalYearId = ID;
                obj.FromDate =dtpFrom.Value;
