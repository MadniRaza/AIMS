...
namespace MMR_AIMS
{
    public partial class fPurchaseInvoice : Form
    {
        #region Data Fields
        long ID = 0;
        int VendorId = 0;
        ...
        private void mnuEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtAGNo.Text = dtMaster.Rows[0]["PurchaseInvoiceNumber"].ToString();
                ...
                txtAdditionalDisc.Text = dtMaster.Rows[0]["AdditionalDiscount"].ToString();
                dtpDate.Value = Convert.ToDateTime(dtMaster.Rows[0]["PurchaseInvoiceDate"]);
        ...
        public void SetFormState(string action)
        {
            switch (action.ToLower())
            {
                ...
                case "on_save_uncommitted":
                    ...
                    btnReset.Enabled = true;
                    break;
                case "on_items_retreiving":
                    PauseActions(true);
                    break;
                case "on_items_retreival_failed":
                    PauseActions(false);
                    break;
                case "on_items_retreived":
                    PauseActions(false);
        ...
        public void FilterRecords()
        {
            ...
            {
                filter_text += "  (";
                filter_text += " Convert(PurchaseInvoiceNumber,'System.String')  LIKE '%" + search_value + "%'";
                ...
                filter_text += " OR Convert(PurchaseInvoiceDate,'System.String')  LIKE '%" + search_value + "%'";
                filter_text += " )";
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SetFormState("on_save_uncommitted");
                PurchaseInvoiceModel model = new PurchaseInvoiceModel();
                PurchaseInvoiceModel.PurchaseInvoice obj = new PurchaseInvoiceModel.PurchaseInvoice();
                
                obj.PurchaseInvoiceId = ID;
                obj.PurchaseInvoiceDate = dtpDate.Value;
        ...
        void Print()
        {
            ...
            PurchaseInvoiceModel model1 = new PurchaseInvoiceModel();
            ...
            DataTable dtBalance = ((DataSet)model2.GetVendorBalance(Convert.ToInt32(dtMaster.Rows[0]["VendorId"]),Convert.ToDateTime(dtMaster.Rows[0]["PurchaseInvoiceDate"]))).Tables[0].Copy();
            ...
            dtData.TableName = "PurchaseInvoice";
            ...
            frm.ReportPath = Path.Combine(AppData.IsLive ? AppDomain.CurrentDomain.BaseDirectory : Directory.GetParent(Directory.GetCurrentDirectory()).Parent.FullName, "4-Reports", "3-Purchase", "rptPurchaseInvoice.rdlc");
            frm.HeaderText = "Purchase Invoice";
