...
namespace MMR_AIMS
{
    public partial class fReceipts : Form
    {
        ...
        int CustomerId = 0;
        bool EditItem = false;
        string DetailGridColumns = "CustomerId,BillingName,Amount";
        ...
        private void mnuEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dtpDate.Value = Convert.ToDateTime(dtMaster.Rows[0]["ReceivedOn"]);
        ...
        public void FilterRecords()
        {
            ...
            if (!string.IsNullOrEmpty(search_value))
            {
                ...
                filter_text += " Convert(ReceivedOn,'System.String')  LIKE '%" + search_value + "%'";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ReceiptVoucherModel model = new ReceiptVoucherModel();
                ReceiptVoucherModel.ReceiptVoucher obj = new ReceiptVoucherModel.ReceiptVoucher();
                
                obj.VoucherId = ID;
                
                obj.ReceivedOn = dtpDate.Value;
        ...
        void Print()
        {
            ...
            ReceiptVoucherModel model1 = new ReceiptVoucherModel();
            ...
            dtData.TableName = "ReceiptVoucher";
            ...
            frm.ReportPath = Path.Combine(AppData.IsLive ? AppDomain.CurrentDomain.BaseDirectory : Directory.GetParent(Directory.GetCurrentDirectory()).Parent.FullName, "4-Reports", "4-Sale", "rptReceiptVoucher.rdlc");
            frm.HeaderText = "Receipt Voucher";
